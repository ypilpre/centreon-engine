  ...
  for (umap<std::string, com::centreon::shared_ptr<::host> >::const_iterator
    ...
    stream
      ...
      "\thost_name=" << hst->get_host_name() << "\n"
         ...
         // XXX "\tnotification_period=" << (hst->get_notification_period() ? hst->get_notification_period()->name : "") << "\n"
  ...
  for (umap<std::pair<std::string, std::string>, com::centreon::shared_ptr<::service> >::const_iterator
    ...
    stream
      << "servicestatus {\n"
         ...
         // XXX "\tnotification_period=" << (svc->get_notification_period() ? svc->get_notification_period()->name : "") << "\n"
