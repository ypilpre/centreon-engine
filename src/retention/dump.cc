...
std::ostream& dump::host(std::ostream& os, ::host const& obj) {
  os << "host {\n"
    ...
    "active_checks_enabled=" << obj.are_checks_enabled() << "\n"
    ...
    // XXX "event_handler_enabled=" << obj.event_handler_enabled << "\n"
    "flap_detection_enabled=" << obj.is_flap_detection_enabled() << "\n"
    ...
    // XXX "modified_attributes=" << (obj.get_modified_attributes() & ~config->retained_host_attribute_mask()) << "\n"
    ...
    "notified_on_down=" << obj.is_notified_on_down() << "\n"
    "notified_on_unreachable=" << obj.is_notified_on_unreachable() << "\n"
    "obsess_over_host=" << obj.is_obsessed_over() << "\n"
...
std::ostream& dump::service(std::ostream& os, ::service const& obj) {
  os << "service {\n"
    ...
    // XXX "event_handler=" << (obj.event_handler ? obj.event_handler : "") << "\n"
    // XXX "event_handler_enabled=" << obj.event_handler_enabled << "\n"
    // XXX "flap_detection_enabled=" << obj.flap_detection_enabled << "\n"
    "has_been_checked=" << obj.has_been_checked() << "\n"
    "is_flapping=" << obj.is_flapping() << "\n"
    // XXX "last_acknowledgement=" << obj.get_last_acknowledgement() << "\n"
    "last_check=" << static_cast<unsigned long>(obj.get_last_check()) << "\n"
    ...
    // XXX "notification_period=" << (obj.notification_period ? obj.notification_period : "") << "\n"
    "notifications_enabled=" << obj.are_notifications_enabled() << "\n"
    "notified_on_critical=" << obj.is_notified_on_critical() << "\n"
    "notified_on_unknown=" << obj.is_notified_on_unknown() << "\n"
    "notified_on_warning=" << obj.is_notified_on_warning() << "\n"
    "obsess_over_service=" << obj.is_obsessed_over() << "\n"
    "passive_checks_enabled=" << obj.get_accept_passive_checks() << "\n"
    "percent_state_change=" << std::setprecision(2) << std::fixed << obj.get_percent_state_change() << "\n"
    "performance_data=" << obj.get_perfdata() << "\n"
    "plugin_output=" << obj.get_output() << "\n"
