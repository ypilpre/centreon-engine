...
std::ostream& dump::host(std::ostream& os, ::host const& obj) {
  os << "host {\n"
    ...
    "notified_on_unreachable=" << obj.get_notify_on(engine::host::ON_UNREACHABLE) << "\n"
...
std::ostream& dump::service(std::ostream& os, ::service const& obj) {
  os << "service {\n"
    ...
    "notified_on_unknown=" << obj.get_notify_on(engine::service::ON_UNKNOWN) << "\n"
    "notified_on_warning=" << obj.get_notify_on(engine::service::ON_WARNING) << "\n"
